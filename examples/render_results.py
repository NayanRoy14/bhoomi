...
def load(name: str) -> np.ndarray:
    with rasterio.open(rf"{OUT}\{name}.tif") as src:
...
plt.savefig(rf"{OUT}\kolkata_change.png", dpi=110, facecolor="white")
...
plt.tight_layout()
plt.savefig(rf"{OUT}\ndvi_change_large.png", dpi=115, facecolor="white")
print(f"wrote {OUT}\\ndvi_change_large.png")
...
ax.axis("off")
plt.tight_layout()
plt.savefig(rf"{OUT}\ndvi_loss_mask.png", dpi=115, facecolor="white")
print(f"wrote {OUT}\\ndvi_loss_mask.png")
