...
- **Fill the username** in the opening line — being an existing registered user helps.
- **Add a phone number.** Indian government correspondence often gets a phone reply.
